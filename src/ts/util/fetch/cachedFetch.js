...
export const cachedSimpleFetch = function (input, init) {
...
const makeFetchAs = function (then) {
    return (input, init) => cachedSimpleFetch(input, init).then(then);
};
export const cachedFetch = Object.assign(cachedSimpleFetch, ...[
